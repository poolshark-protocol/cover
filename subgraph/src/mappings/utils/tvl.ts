...
import { BasePrice, CoverPoolFactory, CoverPool, Token } from '../../../generated/schema'
...
export function updateDerivedTVLAmounts(
  ...
  pool: CoverPool,
  factory: CoverPoolFactory,
  oldCoverPoolTotalValueLockedEth: BigDecimal
  ...
  factory.totalValueLockedEth = factory.totalValueLockedEth.minus(oldCoverPoolTotalValueLockedEth)
