import { Burn, Mint } from "../../generated/PoolsharkHedgePool/PoolsharkHedgePool";
import { Address, BigInt, Bytes, ethereum, log } from '@graphprotocol/graph-ts';
import { safeLoadHedgePool, safeLoadPosition, safeLoadToken } from "./utils/loads";
...
export function handleMint(event: Mint): void {
    ...
    let loadHedgePool = safeLoadHedgePool(poolAddress)
