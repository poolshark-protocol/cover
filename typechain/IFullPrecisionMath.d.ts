...
interface IFullPrecisionMathInterface extends ethers.utils.Interface {
  functions: {
...
export class IFullPrecisionMath extends BaseContract {
  ...
  interface: IFullPrecisionMathInterface;
