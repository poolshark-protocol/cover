...
interface IConcentratedPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class IConcentratedPool extends BaseContract {
  ...
  interface: IConcentratedPoolInterface;
