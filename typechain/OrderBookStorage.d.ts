...
interface OrderBookStorageInterface extends ethers.utils.Interface {
  functions: {
...
export class OrderBookStorage extends BaseContract {
  ...
  interface: OrderBookStorageInterface;
