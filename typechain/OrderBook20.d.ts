...
interface OrderBook20Interface extends ethers.utils.Interface {
  functions: {
    ...
    "limitOrder(address,uint256,uint256,uint256,bool,bool)": FunctionFragment;
...
export class OrderBook20 extends BaseContract {
  ...
  interface: OrderBook20Interface;
