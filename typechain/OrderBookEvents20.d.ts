...
interface OrderBookEvents20Interface extends ethers.utils.Interface {
  functions: {};
...
export class OrderBookEvents20 extends BaseContract {
  ...
  interface: OrderBookEvents20Interface;
