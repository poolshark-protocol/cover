...
interface IPoolsharkLibrariesInterface extends ethers.utils.Interface {
  functions: {
...
export class IPoolsharkLibraries extends BaseContract {
  ...
  interface: IPoolsharkLibrariesInterface;
