...
describe('CoverPool Tests', function () {
    ...
    it("pool0 - liquidity should not be locked due to Deltas.to calculation :: GUARDIAN AUDITS", async function () {
        ...
        await validateBurn({
            ...
            balanceOutIncrease: BigNumber.from("94989239444140347193"), // ~(100 - 5)
            lowerTickCleared: true,
            upperTickCleared: true,
            revertMessage: '',
        });
        ...
        await validateBurn({
            ...
            balanceOutIncrease: BigNumber.from("94989239444140347192"), // This is the increase it ought to be it is actually 99999999999999999999
            lowerTickCleared: true,
            upperTickCleared: true,
            revertMessage: "",
        });
    ...
    it("pool0 - Claim on stash tick; Mint again on start tick in same transaction :: alphak3y 313", async () => {
        ...
        await validateMint({
            ...
            amount: tokenAmount,
            zeroForOne: true,
            balanceInDecrease: BigNumber.from('43405733931640686250'), // alice gets amounOut back
    ...
    it("pool0 - Claim on stash tick; Mint again on stash tick", async () => {
        ...
        await validateBurn({
            ...
            zeroForOne: true,
            balanceInIncrease: BigNumber.from('10000000000000000000'),
            balanceOutIncrease: BigNumber.from('73277601343136835736'),
            lowerTickCleared: false,
            upperTickCleared: true,
            revertMessage: '',
        })
    ...
    it('pool0 - Should move TWAP in range, fill, sync lower tick, and clear stash deltas 57', async function () {
        ...
        await validateBurn({
            ...
            liquidityAmount: liquidityAmount4,
            zeroForOne: true,
            balanceInIncrease: BigNumber.from('49815343322651003239'),
    ...
    it('pool0 - Should process section1 claim on partial previous auction 114', async function () {
        ...
        await validateBurn({
            ...
            zeroForOne: true,
            balanceInIncrease: BigNumber.from('0'),
            balanceOutIncrease: BigNumber.from('79800100020960188460'),
            lowerTickCleared: true,
            upperTickCleared: true,
            revertMessage: '',
        })
    ...
    it('pool0 - Should partially remove liquidity on second claim 115', async function () {
        ...
        await validateBurn({
            ...
            zeroForOne: true,
            balanceInIncrease: BigNumber.from('0'),
            balanceOutIncrease: BigNumber.from('44949761991305334885'),
            lowerTickCleared: false,
            upperTickCleared: false,
            revertMessage: '',
        })
    ...
    it('pool0 - Should move TWAP up and create stopTick0 during sync 27', async function () {
        ...
        await validateBurn({
            ...
            zeroForOne: true,
            balanceInIncrease: BigNumber.from('5000000000000000000'),
            balanceOutIncrease: BigNumber.from('69966961710462894065'),
            lowerTickCleared: false,
            upperTickCleared: true,
            revertMessage: '',
        })
        ...
        await validateBurn({
            ...
            zeroForOne: true,
            balanceInIncrease: BigNumber.from('5000000000000000000'),
            balanceOutIncrease: BigNumber.from('94979461084463047277'),
            lowerTickCleared: false,
            upperTickCleared: true,
            revertMessage: '',
        })
    ...
    it('pool0 - Should claim multiple times on the same tick with a swap in between 29', async function () {
        ...
        await validateBurn({
            ...
            balanceOutIncrease: BigNumber.from('79921885206090573759'),
            lowerTickCleared: false,
            upperTickCleared: false,
            revertMessage: '',
        })
