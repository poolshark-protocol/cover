...
describe('CoverPool Tests', function () {
    ...
    it("pool0 - fully filled auction should push claim to next tick :: GUARDIAN AUDITS 21", async () => {
        ...
        await validateSwap({
            ...
            amountIn: tokenAmount,
            priceLimit: maxPrice,
            balanceInDecrease: BigNumber.from('24892711623697875921'),
    ...
    it("pool0 - accounting should be correct for multiple positions sharing same range :: GUARDIAN AUDITS", async () => {
        ...
        await validateSwap({
            ...
            amountIn: tokenAmount,
            priceLimit: maxPrice,
            balanceInDecrease: BigNumber.from('49785423247395751842'),
        ...
        await validateSwap({
            ...
            amountIn: tokenAmount,
            priceLimit: maxPrice,
            balanceInDecrease: BigNumber.from('37264467655248218931'),
    ...
    it("pool0 - amountOutDeltaMax should not underflow :: GUARDIAN AUDITS", async function () {
        ...
        await validateSwap({
            ...
            amountIn: tokenAmount,
            priceLimit: maxPrice,
            balanceInDecrease: BigNumber.from('74727967618882864171'),
    ...
    it("pool0 - underflow when claiming for the second time :: GUARDIAN AUDITS 58", async () => {
        ...
        await validateSwap({
            ...
            amountIn: tokenAmount,
            priceLimit: maxPrice,
            balanceInDecrease: BigNumber.from('12421489218416072977'),
    ...
    it('pool0 - Should move TWAP in range, fill, sync lower tick, and clear stash deltas 57', async function () {
        ...
        await validateSwap({
            ...
            amountIn: tokenAmount.mul(2),
            priceLimit: maxPrice,
            balanceInDecrease: BigNumber.from('49785448137620406518'),
    ...
    it('pool1 - Should move TWAP in range by one, partial fill w/ max int128 of liquidity, and burn', async function () {
        ...
        await validateSwap({
            ...
            amountIn: tokenAmount.div(10),
            priceLimit: minPrice,
            balanceInDecrease: BigNumber.from('2980787058715'),
